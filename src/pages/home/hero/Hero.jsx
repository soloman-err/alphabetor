    ...
    >
      ...
      <div className="text-white pt-10 md:pt-20 xl:pt-24 font-bold md:text-[2rem] lg:text-[3rem] xl:text-[4rem]">
        <h2 className="text-xl md:text-2xl xl:text-4xl 2xl:text-5xl text-center italic">
          <span className="text-2xl md:text-4xl 2xl:text-6xl">W</span>here
          Learning Meets Inspiration, <br /> Alphabetor Guides the Way.
        </h2>
      </div>
      ...
      <div className="flex flex-row items-center gap-2">
        ...
        />
        <button className="flex flex-row items-center gap-1 px-2 py-1 text-white font-bold bg-cyan-600">
          Search <FaSearch />{' '}
        </button>
      </div>
    </div>
